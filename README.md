...
Hello! In this tutorial, I will install Active Directory within Azure Virtual Machines. Like the previous one, this tutorial will assume you have two Virtual Machines on Azure already created. One VM using Windows server 2022(Domain Controller) which I will be installing Active Directory on and another VM using Windows 10(the Client) that I will join later to the Domain controller.

<b>*Note: Creating the Client VM is not a mandatory step. This is only for teaching purposes to emulate a random computer at a school, business, etc that is connected to a Domain Controller*</b>
